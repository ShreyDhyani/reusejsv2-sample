...
const ReuseTextInput = (props) => {
    ...
    const finalInputClassName = twMerge("bg-white w-full mt-1 rounded-md border-black border rounded-md px-2 py-1", props.className);
...
const ReusePasswordInput = (props) => {
    ...
    const passwordButton = (React.createElement("button", { className: twMerge("absolute top-2 right-2", props.suffixPositionClasses), onClick: () => {
...
export { HeadlessTextInput, ReusePasswordInput, ReuseTextInput };
